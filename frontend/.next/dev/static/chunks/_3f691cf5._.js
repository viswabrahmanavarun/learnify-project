...
"[project]/app/dashboard/student/certificates/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function StudentCertificatesPage() {
  ...
  ========================= */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "StudentCertificatesPage.useEffect": ()=>{
            const fetchCertificates = {
                "StudentCertificatesPage.useEffect.fetchCertificates": async ()=>{
                    try {
                        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("/certificates/my");
            ...
            }["StudentCertificatesPage.useEffect.fetchCertificates"];
            fetchCertificates();
        }
    }["StudentCertificatesPage.useEffect"], []);
    /* =========================
  ...
  ========================= */ const downloadCertificate = async (courseId, courseTitle, certificateId)=>{
        try {
            ...
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/courses/${courseId}/certificate/download`, {
                responseType: "blob"
            });
            const blob = new Blob([
                res.data
...
_s(StudentCertificatesPage, "k5Lz0T93X+L91NnGuXoH6Nn34VE=", false, function() {
    return [
...
//# sourceMappingURL=_3f691cf5._.js.map